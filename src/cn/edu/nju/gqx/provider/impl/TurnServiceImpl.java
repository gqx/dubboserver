...
public class TurnServiceImpl implements TurnService{
	...
	@Resource(name = "turntaskWithExedateStrategy")
	private TurntaskStrategy turntaskStrategy;
...
//			String execute_date = getExecuteDate(eturn.attributeValue("dayId"));
...
//		}
		this.turntaskStrategy.createTurntaskByConfig(daysBeforeStart);
	}
	...
	public void startAutoTaskBySysname(boolean isRestart,String sysname) {
		// TODO Auto-generated method stub
		this.turntaskStrategy.startAutoTaskBySysname(isRestart, sysname);
//		if(isRestart){
//			setRestartTime();
//		}
//
...
//								// turn on task
//								System.out.println("$$$$$$$$$$$$$$$$$$$$"+"taskon:"+task.getTtid());
//								turnOnTask(task);
//							}else {													
//								// pass token
...
//		updateTurnTask(sysname,0);
		this.turntaskStrategy.stopAutoTaskBySysname(sysname,stopSwitches);
	}
